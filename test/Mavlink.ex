defmodule Mavlink do
  @moduledoc ~s(Mavlink 3.0 generated by Mavlink mix task from test/mavlink.xml on 2018-10-05 13:06:05.894027Z)
  ...
  def describe_params(:mav_cmd_nav_waypoint), do: [{1, "Hold time in decimal seconds. (ignored by fixed wing, time to stay at MISSION for rotary wing)"}, {2, "Acceptance radius in meters (if the sphere with this radius is hit, the MISSION counts as reached)"}, {3, "0 to pass through the WP, if > 0 radius in meters to pass by WP. Positive value for clockwise orbit, negative value for counter-clockwise orbit. Allows trajectory control."}, {4, "Desired yaw angle at MISSION (rotary wing). NaN for unchanged."}, {5, "Latitude"}, {6, "Longitude"}, {7, "Altitude"}]
  ...
  def describe_params(:mav_cmd_do_control_video), do: [{1, "Camera ID (-1 for all)"}, {2, "Transmission: 0: disabled, 1: enabled compressed, 2: enabled raw"}, {3, "Transmission mode: 0: video stream, >0: single images every n seconds (decimal)"}, {4, "Recording: 0: disabled, 1: enabled compressed, 2: enabled raw"}, {5, "Empty"}, {6, "Empty"}, {7, "Empty"}]
